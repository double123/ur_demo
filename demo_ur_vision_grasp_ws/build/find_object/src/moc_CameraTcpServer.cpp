...
#include "../../../src/find_object/src/CameraTcpServer.h"
...
void find_object::CameraTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CameraTcpServer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject find_object::CameraTcpServer::staticMetaObject = { {
    &QTcpServer::staticMetaObject,
    qt_meta_stringdata_find_object__CameraTcpServer.data,
    qt_meta_data_find_object__CameraTcpServer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
