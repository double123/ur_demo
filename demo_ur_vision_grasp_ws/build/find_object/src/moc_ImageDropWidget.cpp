...
#include "../../../src/find_object/src/ImageDropWidget.h"
...
void find_object::ImageDropWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ImageDropWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ImageDropWidget::*)(const QStringList & );
...
QT_INIT_METAOBJECT const QMetaObject find_object::ImageDropWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_find_object__ImageDropWidget.data,
    qt_meta_data_find_object__ImageDropWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
